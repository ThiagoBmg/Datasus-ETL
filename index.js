...
//console.log(tb_estabelecimento.d_C.slice(0,1)); // amostra de dados
...
//carregando nova consulta
//const tb_tipoUnidade = new ETL("./data/tbTipoUnidade.csv");
//console.log(tb_tipoUnidade.d_C.slice(0,1)); // amostra de dadoos

var m_tipo = [0,0] ; // variavel que vai guardar o tipo com mais unidades
...
//console.log(tb_tipoUnidade.d_C);
